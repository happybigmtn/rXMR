...
complete -c monerod -l p2p-bind-port -r -d "Port for p2p network protocol (IPv4). Default: 18880, 28880 if 'testnet', 38880 if 'stagenet'"
complete -c monerod -l p2p-bind-port-ipv6 -d "Port for p2p network protocol (IPv6). Default: 18880, 28880 if 'testnet', 38880 if 'stagenet'"
...
complete -c monerod -l rpc-bind-port -r -d "Port for RPC server. Default: 18881, 28881 if 'testnet', 38881 if 'stagenet'"
